...
<form method="post">
<b>NFS mode:</b><br /><br />
<p><b>Network File System</b> is a simple method for service <br />
of file storage.It is a non-encrypted method of Ekeka.
</p>
...
if conf['mode'][0]=="start":
	print "<META HTTP-EQUIV=refresh CONTENT=\"0;URL=http://www.welkins.com/cgi-bin/startnfs.py\">\n"
